...
//function
    ...
    function enqueue() {
        wp_enqueue_script(
                'field-select-image-js', TEMPLATEURL . '/core/theme-options/custom-fields/select_image/field_select_image.js', array(), time(), true
        );

        wp_enqueue_style(
                'redux-field-select-image-css', TEMPLATEURL . '/core/theme-options/custom-fields/select_image/field_select_image.css', time(), true
        );
    }
