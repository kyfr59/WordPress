...
if ( ! defined( 'RWMB_URL' ) )
	define( 'RWMB_URL', trailingslashit(TEMPLATEURL . '/core/meta-box/meta-box') );
...
// post formats and portfolio template scripts
function enqueue_additional_scripts() {
    $screen = get_current_screen();   

    if ($screen->base == 'post'){
        wp_enqueue_script('rwmb-post-formats', TEMPLATEURL . '/core/meta-box/custom-fields/post-format.js', array('jquery'), RWMB_VER, true);
        wp_enqueue_script('rwmb-page-template', TEMPLATEURL . '/core/meta-box/custom-fields/page-template.js', array('jquery'), RWMB_VER, true);   
    }
