...
function theme_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name' => 'Elvyre Core plugin', // The plugin name
            'slug' => 'elvyre-core', // The plugin slug (typically the folder name)
            'source' => 'elvyre-core.zip', // The plugin source
        ...
        array(
            'name' => 'Content Manager', // The plugin name
            'slug' => 'content-manager', // The plugin slug (typically the folder name)
            'source' => 'https://bitbucket.org/pixelindustry/public-repository/downloads/content-manager.zip', // The plugin source
            'required' => true, // If false, the plugin is only 'recommended' instead of required
            'version' => pi_plugin_version_check('content-manager'), // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
            'external_url' => '', // If set, overrides default API URL and points to an external URL
        ),
        ...
        array(
            ...
            'slug' => 'recent-posts-widget', // The plugin slug (typically the folder name)
            'source' => 'recent-posts-widget.zip', // The plugin source
            'required' => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            'name' => 'TweetScroll Widget', // The plugin name
            'slug' => 'tweetscroll-widget', // The plugin slug (typically the folder name)            
            'required' => false, // If false, the plugin is only 'recommended' instead of required
        ...
        array(
            ...
            'required' => false, // If false, the plugin is only 'recommended' instead of required
            'version' => '2.1.12' // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented            
        ),
        array(
    ...
    $theme_text_domain = 'pi_framework';
    ...
    $config = array(
        ...
        'default_path' => get_stylesheet_directory() . '/core/plugin-activation/plugins/', // Default absolute path to pre-packaged plugins
